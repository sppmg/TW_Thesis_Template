...
The unit is mm , origin at bottom left. I recommend add ``colorgrid'' option to \textbackslash{}documentclass  e.g. In this tex file:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Define local variable (e.g. cover use main \title == \titleZh but letters use \titleEn )
...
\cleardoublepage\thispagestyle{empty}
\includepdf[pagecommand={   \placetextbox{128}{270}{\fs{14}\author}%
                            \placetextbox{70}{258}{\fs{14}\deptshort}%
