...
\begin{figure}
    ...
    \subcaptionbox
        ...
        {\includegraphics[width=0.3\linewidth]{titleFontStyle_sf.png}}
    ~
    \subcaptionbox
        {楷體中文+襯線英文
        \label{fig:titleFontStyle_rm}}
        {\includegraphics[width=0.3\linewidth]{titleFontStyle_rm.png}}
...
\begin{figure}[!h]
    ...
    \caption{\textbackslash{}def\textbackslash{}titleStyle\{0\}}
...
\begin{figure}[!h]
    ...
    \caption{\textbackslash{}def\textbackslash{}titleStyle\{1\}}
...
\begin{figure}[!h]
    ...
    \caption{\textbackslash{}def\textbackslash{}titleStyle\{1\}與\textbackslash{}leftskip}
